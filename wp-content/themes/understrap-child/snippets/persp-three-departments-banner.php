...
<div class="<?php echo $class;?>">
    <div class="wrapper_three_departments">
        ...
        <?php for ($i=0; $i < $pamount; $i++) { ?>
            <div class="departments_item col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                <a href="%content" class="banner_department">

                <div class="col-xl-12 col-lg-12 col-md-8 col-sm-8 col-8 banner_department_label">
                ...
                <div class="col-xl-12 col-lg-12 col-md-4 col-sm-4 col-4 banner_department_symbol">
                    <img src="%content" class="symbol_department">
                </div>
                <div class="banner_department_line hidden-lg-up"></div>
                </a>
            </div>
        <?php } ?>
        </div>
